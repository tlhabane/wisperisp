...
use App\Domain\Customer\Service\UpdateCustomer\UpdateCustomerService;
...
final class UpdateCustomerAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $customerService = new UpdateCustomerService($container->get(PDO::class));
            $response = $customerService->updateCustomer($data);
