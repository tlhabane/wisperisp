...
use App\Domain\Customer\Service\UploadCustomers\UploadCustomerDataService;
...
final class UploadCustomerDataAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $customerService = new UploadCustomerDataService($container->get(PDO::class));
            $response = $customerService->uploadCustomers($uploadedFiles);
