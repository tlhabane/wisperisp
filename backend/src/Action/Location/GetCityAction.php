...
use App\Domain\Location\Service\GetCityService;
...
final class GetCityAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $locationService = new GetCityService($container->get(PDO::class));
            $response = $locationService->getCity($data);
